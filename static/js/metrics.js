...
{ // Yandex reklama
  ...
  window.YA_RTB = {1:1, 2:2, 3:3, 4:4, 5:1, 6:1, 7:1, feed:10, widget_books:5, widget_songs:6, inimage:12};
  window.YA_TMR = [];
    ...
    function ads(){ 
      function run(){ console.log(blid,rtbid,typ,p_dark);
        if(window.YA_RTB[rtbid]) switch(typ){
          ...
          case 'widget': window.yaContextCb.push(function(){Ya.Context.AdvManager.renderWidget({darkTheme:p_dark, blockId:'C-A-14075053-'+rtbid, renderTo:blid});}); break;
