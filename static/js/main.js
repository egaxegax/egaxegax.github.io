...
'</a></svg>';
  ...
  ul.appendChild(li);
  li.id = 'songs';
  li.className = 'inl hspace' + (sel == 'songs' ? ' wrap3' : '');
  li.innerHTML = 
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
'<a class="nodecor" xlink:title="Аккорды, песни, стихи" xlink:href="https://egaxegax.appspot.com/songs/">'+
...
'</svg>';
  ...
  li.innerHTML =
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
'<a class="nodecor" xlink:title="Карта-Навигатор с проекциями dbcartajs" xlink:href="https://egaxegax.github.io/dbcartajs">'+
