...
'<a class="nodecor" title="О сайте и контакты" href="/about">'+
...
'</svg></a>'+
  ...
  '<li id="vesti" class="inl '+(item === 'vesti' ? ' wrap3' : '')+'">'+
'<a class="nodecor" title="Записки и сообщения" href="/vesti">'+
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
...
'<a class="nodecor" title="Заметки и посты" href="/posts">'+
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
...
'</svg></a>'+
  '</li>'+
  '<li id="fotki" class="inl '+(item === 'fotki' ? ' wrap3' : '')+'">'+
'<a class="nodecor" title="Фотки и картинки" href="/fotki">'+
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
...
'<a class="nodecor" title="Аккорды, песни, стихи" href="/songs">'+
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
...
'<a class="nodecor" title="Книги, списки для чтения" href="/books">'+
'<svg width="120" height="80" xmlns="http://www.w3.org/2000/svg">'+
...
(has_previous ? 
  '<a class="nodecor hspace2" href="?'+urlBuild({page: previous_page_number})+'">&larr; &nbsp; Назад</a>'
: 
(has_next ? 
  '<span class="hspace2 lightgray">&larr; &nbsp; Назад</span>'
: 
  ''))+
(num_pages > 1 ?
...
:
  '')+
(has_next ? 
  '<a class="nodecor hspace2" href="?'+urlBuild({page: next_page_number})+'">Далее &nbsp; &rarr;</a>'
:
(has_previous ?
  '<span class="hspace2 lightgray">Далее &nbsp; &rarr;</span>'
:
  ''))+
'</p>';
...
'<g transform="translate(20,200) scale(0.08,-0.08)" fill="#000000" stroke="none">'+
'<path d="M1539 2009 c-88 -17 -112 -35 -107 -79 4 -32 37 -38 84 -15 52 24 245 33 277 12 49 -32 97 -24 97 18 0 29 -40 62 -85 71 -64 12 -186 9 -266 -7z"/>'+
'<path d="M496 1949 c-27 -10 -52 -16 -56 -14 -23 14 -48 -91 -26 -112 15 -16 59 -8 73 14 22 33 69 44 186 42 58 0 110 2 116 6 15 9 14 62 -1 72 -7 4 -65 8 -128 9 -91 2 -126 -2 -164 -17z"/>'+
'<path d="M644 1756 c-3 -8 -4 -25 -2 -38 2 -19 9 -23 38 -23 33 0 35 2 35 35 0 32 -3 35 -33 38 -21 2 -34 -2 -38 -12z"/>'+
'<path d="M1574 1756 c-3 -8 -4 -25 -2 -38 2 -19 9 -23 38 -23 33 0 35 2 35 35 0 32 -3 35 -33 38 -21 2 -34 -2 -38 -12z"/>'+
'<path d="M1111 1646 c-8 -9 -12 -52 -13 -112 l0 -97 53 -71 c30 -38 59 -80 64 -92 6 -13 38 -52 73 -87 34 -36 62 -72 62 -80 0 -12 -18 -17 -76 -22 -104 -10 -169 -2 -205 24 -67 50 -115 1 -67 -68 19 -27 31 -34 68 -39 110 -13 332 -1 357 19 17 15 27 89 14 102 -6 6 -11 18 -11 26 0 9 -22 39 -49 67 -48 50 -141 176 -141 190 0 5 -12 21 -27 37 -26 26 -28 35 -30 113 -1 46 -5 88 -8 94 -9 15 -51 12 -64 -4z"/>'+
'<path d="M860 732 c-36 -20 -94 -57 -130 -83 -36 -26 -80 -58 -99 -71 -60 -41 -91 -75 -91 -102 0 -45 55 -56 93 -17 37 37 208 158 272 192 57 29 65 31 147 27 63 -3 92 -9 106 -21 10 -9 22 -17 26 -17 4 0 31 -18 61 -40 30 -22 63 -40 74 -40 11 0 22 -4 25 -8 3 -4 31 -21 63 -36 138 -65 169 -81 194 -99 17 -12 39 -17 65 -15 36 3 39 6 42 35 3 30 0 34 -60 63 -35 17 -70 35 -78 40 -8 5 -77 39 -153 75 -75 37 -140 71 -143 76 -3 5 -33 24 -67 41 -57 29 -71 31 -172 33 -109 3 -111 2 -175 -33z"/>'+
'</g>'+
'</svg>';
}
//
