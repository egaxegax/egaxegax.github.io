...
RSSlist = {
  'anekdot_day': {'hdr':'Анекдоты из России. Лучшее за день', 'url':'https://www.anekdot.ru/rss/export20.xml'},
  'anekdot_10': {'hdr':'Анекдоты из России. Свежая десятка анекдотов', 'url':'https://www.anekdot.ru/rss/export_j.xml'},
}
