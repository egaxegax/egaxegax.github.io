...
RSSlist = [
  ...
  ('Подборка из Youtube/Путешествия', 'channel_id=UCCjl8Xzb_uYIgrpef-tz7WA'), #dalnoboy_126
  ...
  ('Подборка из Youtube/Жизнь в США', 'channel_id=UCoqxGcZlVBaJ8f3D08ytZ-g'), #Славчик USA
