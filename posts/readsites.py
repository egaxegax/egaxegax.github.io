...
RSSlist = {
  ...
  'artfile':     {'hdr':'Подборка с сайтов/Artfile.ru',           'url':'https://www.artfile.ru/artfile.rss',      'cut':1000, 'total':15, 'ctag': 'channel', 'itag': 'item','sm':''},
  'ixbt_tech':   {'hdr':'Подборка с сайтов/iXBT.com',             'url':'https://www.ixbt.com/export/articles.rss','cut':1000, 'total':10,'ctag': 'channel', 'itag': 'item', 'sm':''},
