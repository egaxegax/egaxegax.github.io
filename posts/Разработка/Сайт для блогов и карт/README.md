...
Подробная инструкция о том, как пользоваться сайтом, есть в *README*-файле [описания проекта](//github.com/egaxegax/egaxegax.github.io#readme).<!--n:Создание статического сайта для блогов:s:0:e:4618-->
<!----><!--2013-09-20 21:28:19-->
...
В целом получается, что в Canvas карта отрисовывается намного быстрее, чем в SVG. Особенно это заметно на планшете.<!--n:Карта Московского метро на Canvas:s:4711:e:2743-->
<!----><!--2014-04-06 19:44:46-->
...
![worldmap-ortho.jpg](http://img-fotki.yandex.ru/get/9816/136640652.0/0_e0112_e8d7e76f_L.jpg)<!--n:gdal_translate и gdalwarp для перепроицирования изображений:s:7534:e:3051-->
<!----><!--2014-03-02 18:53:53-->
...
Примеры проекта можно посмотреть на сaйте [dbcartajs.appspot.com](http://dbcartajs.appspot.com). Исходники доступны в [GitHub](http://github.com/egaxegax/dbcartajs).<!--n:Идея создания проекта:s:16993:e:5817-->
<!----><!--2013-11-24 17:34:57-->
...
В общем, как говорится, жителям Подольска, Люберец и Луховиц добро пожаловать, москвичам просьба не беспокоить.<!--n:Схема пригородного движения жд сообщения Москвы и МО:s:22875:e:3765-->
<!----><!--2015-01-11 10:56:12-->
...
В планах научиться фокусировать в центре сцены другие объекты, кроме Земли, также добавить новые объекты - астероиды, кометы.<!--n:Звездное небо на webGL с использованием three.js:s:26762:e:5462-->
<!----><!--2023-02-23 12:40:09-->
## dbcartajs
...
</table><!--n:Описание и примеры:s:32326:e:6588-->
<!----><!--2015-05-19 19:42:54-->
...
Управлять картой можно мышью. При таскании мышью происходит вращение карты по сфере по 3 осям, а не смещение на плоскости. Это порождает эффект бесконечного зацикливания карты вдоль оси X.<!--n:Пересчет изображений под разные картографические проекции в webGL:s:38973:e:4116-->
<!----><!--2025-09-27 03:54:30-->Блог, посвященный разработке проекта [dbcartajs](https://github.com/egaxegax/dbcartajs).
Примеры и статьи доступны также в блоге на [dbcartajs.blogspot.ru](http://dbcartajs.blogspot.ru).<!--n:about:s:43232:e:286-->
<!----><!--2013-07-02 20:51:25-->
...
Проекции пересчитываются из плоских декартовых координат longlat. Если скрипты Proj4js не подключены доступна только плоская проекция longlat.<!--n:Заметки, отзывы, планы проекта карты dbCartajs:s:43547:e:1453-->
<!----><!--2017-08-14 22:40:10-->
## Карты и Google Maps
Очень интересный сайт с тепловой картой цен на недвижимость Москвы и Санкт-Петербурга [https://квартиры-домики.рф/карта-цен](https://квартиры-домики.рф/%D0%BA%D0%B0%D1%80%D1%82%D0%B0-%D1%86%D0%B5%D0%BD)<!--n:Карты и Google Maps:s:45101:e:378-->
<!----><!--2015-10-15 21:38:36-->
...
В общем, кому интересно, смотрите примеры на [dbcartajs.appspot.com](http://dbcartajs.appspot.com).<!--n:Карта Московского Метро. SVG-версия:s:45528:e:3836-->
<!----><!--2025-09-24 17:01:11-->
...
* *readzen.py*    чтение ленты дзен<!--n:Разработка статического сайта для блогов:s:49451:e:2678-->
<!----><!--2013-08-10 19:13:59-->
...
![Starry Sky](http://img-fotki.yandex.ru/get/9555/136640652.0/0_becbd_66ad485b_XL.png)<!--n:Звездное небо на Canvas:s:52230:e:3109-->
