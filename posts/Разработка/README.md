...
Активировать групповую политику для браузера в реестре
    ...
    DisableAppUpdate = DWORD:00000001<!--n:Сценарии для Windows/Запрет вывода сообщений об обновлении Firefox 63 и выше:s:0:e:338-->
<!---->﻿<!--2020-04-19 17:52:23-->
...
где *192.168.0.5* адрес машины где настроен сервер времени.<!--n:Сценарии для Windows/Синхронизация времени под Windows:s:483:e:620-->
<!----><!--2019-07-20 22:30:54-->
## Запрет вывода push-сообщений в *Firefox 44* и выше
В настройках браузера по адресу *about:config* отключить опции

    dom.push.enabled              false
    dom.webnotifications.enabled  false<!--n:Сценарии для Windows/Запрет вывода push-сообщений в Firefox 44 и выше:s:1213:e:299-->
<!----><!--2017-02-18 14:28:56-->
...
Параметр в *about:config* для изменения **general.useragent.override**<!--n:Сценарии для Windows/Строка распознавания User-Agent браузера:s:1642:e:345-->
<!----><!--2019-05-11 11:40:46-->
...
Найти там строку с названием программы (*Яндекс*-браузером или *Microsoft OneDrive*) и удалить ее.<!--n:Сценарии для Windows/Удаление интернет-браузера из запланированных задач Windows:s:2109:e:864-->
<!---->﻿<!--2020-04-14 09:03:23-->
...
Очистить папку *WinSxS* от устаревших обновлений
    ...
    Dism.exe /online /cleanup-image /StartComponentCleanup<!--n:Сценарии для Windows/Очистка от устаревших обновлений:s:3133:e:547-->
<!----><!--2025-09-02 17:35:30-->Советы по настройке и примеры скриптов для работы в ОС Windows.<!--n:Сценарии для Windows/about:s:3796:e:141-->
<!----><!--2024-07-28 11:40:22-->
...
[installation-1.8.1.16-27.12.24_15.22-di.iso](https://home.kataevk.su/Astra%20Linux%20Special%20Edition%201.8.1.16/debian_installer/installation-1.8.1.16-27.12.24_15.22-di.iso)<!--n:Примеры shell-сценариев/Astra Linux SE 1.8 Installation Disc:s:3997:e:521-->
<!----><!--2019-10-05 22:42:55-->
...
Извлекаем и обрезаем дорожку по времени от начала (-ss) с длительностью в сек (-endpos), а также увеличиваем громкость трека га *10 дб* (-af volume=10:0)
    ...
    mencoder v.mp4 -ss 56 -endpos 190 -af volume=10:0 -of rawaudio -oac mp3lame -ovc copy -o a.mp3<!--n:Примеры shell-сценариев/Извлекаем звук из видео с помощью mencoder:s:4617:e:457-->
<!----><!--2012-11-11 19:36:59-->
...
можно так (по непроверенным данным работает только на *RedHat*-совместимых дистрибутивах) 
    ...
    echo HELLOWORLD | passwd --stdin<!--n:Примеры shell-сценариев/Сменить пароль пользователя passwd без запроса:s:5207:e:431-->
<!----><!--2023-09-30 23:23:09-->
...
for root, dirs, files in os.walk('.', topdown=False):
    ...
    for name in files:
        ...
        print ()
        i.close()
```<!--n:Примеры shell-сценариев/Python Ресурсивное объединение файлов:s:5782:e:2862-->
<!----><!--2012-11-14 19:59:57-->
...
Индекс работает на равно (=) когда число полей в запросе больше половины числа полей в индексе. Чувствителен к операциям множеств (>,<,BETWEEN) и конструкции IN (ее нужно заменить на комбинацию с OR).<!--n:Примеры shell-сценариев/PostgreSQL Работа с индексами:s:8773:e:2214-->
<!----><!--2018-01-28 08:28:19-->
...
Пробуем
    ...
    ping ftp
    ping ftp.dom
    ping db.dom<!--n:Примеры shell-сценариев/Пример настройки dns-сервера bind9:s:11096:e:1995-->
<!----><!--2025-09-18 12:31:37-->
...
Включить отображение имён файлов на русском языке
    ...
    git config --local core.quotepath false<!--n:Примеры shell-сценариев/git log Список файлов коммита:s:13212:e:331-->
<!----><!--2013-01-16 20:20:27-->
...
При копировании файлов с кириллицей из *Windows* в *Linux* их содержимое может быть не читабельным. Конвертим их, например, в *utf8*:
    ...
    done<!--n:Примеры shell-сценариев/Перекодировка файлов из Windows в Linux:s:13655:e:689-->
<!----><!--2024-06-24 01:12:02-->
...
подсчёт размера файла/каталога, контрольной суммы, количества строк, копирование файлов и др.
    ...
    find $D -type d -name '??*' | xargs -n1 -P10 -I{} bash -c 'runfunc "{}"'<!--n:Примеры shell-сценариев/xargs Многопоточный запуск команд:s:14469:e:1001-->
<!----><!--2012-11-11 19:42:24-->
...
Пример вызова скрипта как asspass.sh:
    ...
    echo 12345678 | ./asspass.sh ssh user@vm1 "hostname;uname;users;groups"<!--n:Примеры shell-сценариев/Передача пароля из командной строки ssh:s:15593:e:1864-->
<!----><!--2016-01-22 21:41:19-->
## Количество файлов в каталоге
Считаем количество файлов в папке

    ls | wc -l<!--n:Примеры shell-сценариев/Количество файлов в каталоге:s:17592:e:169-->
<!----><!--2020-03-21 16:11:37-->
...
Другой вариант
    ...
    git tag -d <tag_name><!--n:Примеры shell-сценариев/git tag delete Удаление тага в git:s:17878:e:556-->
<!----><!--2024-05-25 01:05:44-->
...
[devel-smolensk-1.6-20.06.2018_15.56.iso](https://dl.astralinux.ru/astra/frozen/1.6_x86-64/1.6.0/iso/devel-smolensk-1.6-20.06.2018_15.56.iso)<!--n:Примеры shell-сценариев/Astra Linux SE 1.6 Installation Disc:s:18545:e:543-->
<!----><!--2021-05-24 01:01:01-->
...
Извлекаем звуковую дорожку по времени длительности
    ...
    mpv file.avi -o file.mp3 --no-video --start=0 --length=61<!--n:Примеры shell-сценариев/Извлекаем звук из видео с помощью mpv:s:19188:e:654-->
<!----><!--2012-11-20 20:10:44-->
...
```<!--n:Примеры shell-сценариев/Python Расширенный аналог утилиты wc в Linux:s:19971:e:5127-->
<!----><!--2013-07-26 20:30:35-->
...
Для компиляции через Visual Studio в настройках проекта нужно выставить флаг препроцессора _USE_32BIT_TIME_T.<!--n:Примеры shell-сценариев/PHP Сборка плагина (extension):s:25232:e:2466-->
<!----><!--2020-12-06 13:45:00-->
## cut Разбиение строки в bash

Разбиваем строку и выделяем подстроку *Солнце стекло* в *bash*

    echo Солнце светит сквозь стекло|cut -d" " -f1,4<!--n:Примеры shell-сценариев/cut Разбиение строки в bash:s:27806:e:268-->
<!---->﻿<!--2020-06-06 18:48:27-->
## Раскадровка видео с помощью mplayer
Получение *jpeg*-файлов из видео

    mplayer -vo jpeg film.mov<!--n:Примеры shell-сценариев/Раскадровка видео с помощью mplayer:s:28181:e:185-->
<!----><!--2022-01-03 01:46:05-->
...
Вывод
    ...
    26360000
    92
    Discharging<!--n:Примеры shell-сценариев/Просмотр заряда батареи ноутбука в консоли Linux:s:28489:e:460-->
<!----><!--2024-05-25 00:05:09-->
...
[base-1.7.4.11-23.06.23_17.13.iso](https://dl.astralinux.ru/astra/frozen/1.7_x86-64/1.7.4/uu/1/iso/base-1.7.4.11-23.06.23_17.13.iso)<!--n:Примеры shell-сценариев/Astra Linux SE 1.7 Installation Disc:s:29098:e:1696-->
<!---->﻿<!--2020-04-06 11:38:04-->
...
или 
    ...
    systemctl restart ntpd<!--n:Примеры shell-сценариев/Конфиг настройки сервера времени NTP:s:30895:e:1086-->
<!----><!--2020-03-22 08:48:27-->
## Кодируем видео из MOV в AVI формат
    mencoder a.mov -o b.avi -oac mp3lame -ovc lavc<!--n:Примеры shell-сценариев/Кодируем видео из MOV в AVI формат:s:32111:e:144-->
<!----><!--2020-04-19 19:36:33-->
## Конфиг привязки DNS-сервера 
    search dom
    nameserver 192.168.0.5<!--n:Примеры shell-сценариев/Конфиг привязки DNS-сервера:s:32375:e:128-->
<!---->﻿<!--2020-04-06 11:44:11-->
...
Конфиг настройки локальной сети */etc/networking/interfaces*
    ...
    iface eth1 inet static
        ...
        netmask 255.255.252.0
        gateway 172.16.2.1
        broadcast 172.16.2.255<!--n:Примеры shell-сценариев/Конфиг настройки сетевых интерфейсов interfaces:s:32615:e:561-->
<!----><!--2018-10-29 21:23:47-->
...
Пример
    ...
    <iframe frameborder=0 scrolling=no width="100%" height="this.height=this.contentWindow.document.body.scrollHeight" src="/"></iframe><!--n:Примеры shell-сценариев/iframe с autoheight по содержимому:s:33320:e:449-->
<!----><!--2017-11-22 21:13:41-->
...
Конфиг */etc/vsftpd.conf*
    ...
    #seccomp_sandbox=NO<!--n:Примеры shell-сценариев/Конфиг для настройки анонимного ftp-сервера:s:33881:e:357-->
<!----><!--2013-09-29 20:03:40-->
...
![nb0.png](http://img-fotki.yandex.ru/get/9302/136640652.0/0_c826f_cdce3b6_XL.png)<!--n:Примеры shell-сценариев/PHP Настройка Visual Studio для разработки плагина:s:34380:e:4530-->
<!----><!--2016-07-23 11:15:01-->
...
```<!--n:Примеры shell-сценариев/Python Конвертируем картинку в base64 строку:s:39054:e:551-->
<!---->﻿<!--2021-03-14 23:20:27-->
...
[mpv](http://mpv.io) новая версия ***mplayer***.<!--n:Примеры shell-сценариев/Раскадровка видео с помощью mpv:s:39740:e:348-->
<!----><!--2020-09-04 16:37:08-->
...
Синхронизация файлов каталогов с помощью утилиты *ltfp*
    ...
    sudo chmod -R 777 .<!--n:Примеры shell-сценариев/Синхронизация каталога по ftp:s:40207:e:372-->
<!----><!--2023-12-16 11:43:22-->
## Запись ISO-образа на флэшку

    dd if="./filename.iso" of="/dev/sdb" status="progress" conv="fsync"<!--n:Примеры shell-сценариев/Запись ISO-образа на флэшку:s:40695:e:157-->
<!----><!--2016-11-30 20:26:58-->
...
Подключается, выводит информацию о системе через *uname*, закрывает соединение.
    ...
    expect "$*"
    send "exit\r"
    expect eof<!--n:Примеры shell-сценариев/Использование ssh через expect с передачей пароля без ввода:s:40963:e:816-->
<!----><!--2025-02-09 00:54:01-->
...
Принудительно обновляем удаленный репо
    ...
    $ git push -f origin master<!--n:Примеры shell-сценариев/git Удаление истории коммитов:s:41944:e:656-->
<!----><!--2016-10-31 19:39:12-->
## autoconf Сборка 32 битной версии программы на 64 битной версии Linux
Запускаем

    ./configure CC="gcc -m32" CXX="g++ -m32"
     make<!--n:Примеры shell-сценариев/autoconf Сборка 32 битной версии программы на 64 битной версии Linux:s:42716:e:221-->
<!----><!--2012-11-12 19:51:55-->
...
Текущим путем является текущий путь в терминале, в котором был выполнен *smbclient*<!--n:Примеры shell-сценариев/Используем Samba для скачиваниязакачивания каталогов:s:43110:e:1136-->
<!----><!--2012-11-11 19:47:05-->
...
Запускаем
    ...
    sh installer.run<!--n:Примеры shell-сценариев/Создание self-extract архива tar:s:44406:e:699-->
<!----><!--2014-01-19 19:47:37-->
...
Например, узнать путь исполняемого файла процесса можно получить так
    ...
    wmic process where (name="cmd.exe") get ExecutablePath<!--n:Примеры shell-сценариев/Получить сведения о запущенном процессеах:s:45215:e:670-->
<!----><!--2015-12-29 21:14:04-->
...
Кому интересно заходите на страницу проекта в репозитории GitHub <a href="http://https://github.com/egaxegax/django-egaxegax">django-egaxegax</a>.<!--n:Примеры shell-сценариев/Python Сайт с использованием Django-nonrel фреймворка:s:46027:e:6321-->
<!----><!--2013-10-01 20:22:22-->
...
Удобен для сжатия *mp3*-файлов с большим битрейтом ( 256, 320 Кб/с ). Использует утилиты *lame* и *id3info*.
    ...
    done<!--n:Примеры shell-сценариев/Конвертор mp3-файлов в VBR-формат:s:52495:e:1911-->
<!----><!--2016-06-06 21:49:40-->
...
После создания зеркала на слэйве нужно создать файл *recovery.conf* для запуска потоковой репликации и восстановления из "горячего" резерва (команда restore_command) одновременно.
    ...
    restore_command='cp /mnt/disk/home/wal_arc/%f -o "%p"'<!--n:Примеры shell-сценариев/PostgreSQL Репликация кластера:s:54526:e:4813-->
<!----><!--2016-11-15 14:14:32-->
## Сборка boost
Пример строки сборки *boost* под *Visual Studio 10.0*

    bjam link=static variant=debug toolset=msvc-10.0<!--n:Примеры shell-сценариев/Сборка boost:s:59452:e:184-->
<!----><!--2025-09-02 17:35:30-->Подборка различных скриптов на языках Bash, Batch, PHP, Python для различных задач.<!--n:Примеры shell-сценариев/about:s:59718:e:166-->
<!----><!--2024-01-01 22:11:49-->
...
Подробная инструкция о том, как пользоваться сайтом, есть в *README*-файле [описания проекта](//github.com/egaxegax/egaxegax.github.io#readme).<!--n:Сайт для блогов и карт/Создание статического сайта для блогов:s:59953:e:4618-->
<!----><!--2013-07-18 19:29:49-->
## Идея
...
Примеры проекта можно посмотреть на сaйте [dbcartajs.appspot.com](http://dbcartajs.appspot.com). Исходники доступны в [GitHub](http://github.com/egaxegax/dbcartajs).<!--n:Сайт для блогов и карт/Идея создания проекта:s:64709:e:5817-->
<!----><!--2013-11-24 17:34:57-->
...
В общем, как говорится, жителям Подольска, Люберец и Луховиц добро пожаловать, москвичам просьба не беспокоить.<!--n:Сайт для блогов и карт/Схема пригородного движения жд сообщения Москвы и МО:s:70632:e:3765-->
<!----><!--2013-07-02 20:51:25-->
...
Проекции пересчитываются из плоских декартовых координат longlat. Если скрипты Proj4js не подключены доступна только плоская проекция longlat.<!--n:Сайт для блогов и карт/Заметки, отзывы, планы проекта карты dbCartajs:s:74560:e:1453-->
<!----><!--2015-01-11 10:56:12-->
...
В планах научиться фокусировать в центре сцены другие объекты, кроме Земли, также добавить новые объекты - астероиды, кометы.<!--n:Сайт для блогов и карт/Звездное небо на webGL с использованием three.js:s:76155:e:5462-->
<!----><!--2014-04-06 19:44:46-->
...
![worldmap-ortho.jpg](http://img-fotki.yandex.ru/get/9816/136640652.0/0_e0112_e8d7e76f_L.jpg)<!--n:Сайт для блогов и карт/gdal_translate и gdalwarp для перепроицирования изображений:s:81760:e:3051-->
<!----><!--2013-09-20 21:28:19-->
...
В целом получается, что в Canvas карта отрисовывается намного быстрее, чем в SVG. Особенно это заметно на планшете.<!--n:Сайт для блогов и карт/Карта Московского метро на Canvas:s:84968:e:2743-->
<!----><!--2017-08-14 22:40:10-->
## Карты и Google Maps
Очень интересный сайт с тепловой картой цен на недвижимость Москвы и Санкт-Петербурга [https://квартиры-домики.рф/карта-цен](https://квартиры-домики.рф/%D0%BA%D0%B0%D1%80%D1%82%D0%B0-%D1%86%D0%B5%D0%BD)<!--n:Сайт для блогов и карт/Карты и Google Maps:s:87833:e:378-->
<!----><!--2023-02-23 12:40:09-->
## dbcartajs
...
</table><!--n:Сайт для блогов и карт/Описание и примеры:s:88301:e:6588-->
<!----><!--2015-10-15 21:38:36-->
...
В общем, кому интересно, смотрите примеры на [dbcartajs.appspot.com](http://dbcartajs.appspot.com).<!--n:Сайт для блогов и карт/Карта Московского Метро. SVG-версия:s:94989:e:3836-->
<!----><!--2025-09-24 17:01:11-->
...
* *readzen.py*    чтение ленты дзен<!--n:Сайт для блогов и карт/Разработка статического сайта для блогов:s:98953:e:2678-->
<!----><!--2013-08-10 19:13:59-->
...
![Starry Sky](http://img-fotki.yandex.ru/get/9555/136640652.0/0_becbd_66ad485b_XL.png)<!--n:Сайт для блогов и карт/Звездное небо на Canvas:s:101773:e:3109-->
<!----><!--2015-05-19 19:42:54-->
...
Управлять картой можно мышью. При таскании мышью происходит вращение карты по сфере по 3 осям, а не смещение на плоскости. Это порождает эффект бесконечного зацикливания карты вдоль оси X.<!--n:Сайт для блогов и карт/Пересчет изображений под разные картографические проекции в webGL:s:104986:e:4116-->
<!----><!--2014-03-02 18:53:53-->
